...
def setup():
    ...
    for path in TLEconstants.ALL_DIRS:
    ...
    logging.basicConfig(format='{asctime}:{levelname}:{name}:{message}', style='{',
                        ...
                        handlers=[logging.StreamHandler(),
                                  TimedRotatingFileHandler(TLEconstants.LOG_FILE_PATH, when='D',
...
def main():
    ...
    if allow_self_register:
        TLEconstants.ALLOW_DUEL_SELF_REGISTER = bool(distutils.util.strtobool(allow_self_register))
