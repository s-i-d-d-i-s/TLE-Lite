...
fontprop = matplotlib.font_manager.FontProperties(fname=TLEconstants.NOTO_SANS_CJK_REGULAR_FONT_PATH)
...
def get_current_figure_as_file():
    filename = os.path.join(TLEconstants.TEMP_DIR, f'tempplot_{time.time()}.png')
